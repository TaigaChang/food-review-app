...
import { postReviewHandler, getRestaurantReviewHandler, getUserReviewsHandler } from '../services/reviews-service.js';
...
router.get('/user', authenticateToken, getUserReviewsHandler);
